 ...
 * @Last Modified time: 2018-08-21 13:48:47
 */
    ...
    <div class="IFE-Content">
      ...
      <div class="IFE-Left">
        <div class="IFE-Left-Top">
          <div class="IFE-Side-Title">贵金属交易统计</div>
...
import circlePie from '@/pages/vip2/circlePie'
import radar from '@/pages/vip2/radar'
import lineChart from '@/pages/vip2/lineChart'
import barChart from '@/pages/vip2/barChart'
import sexPercent from '@/components/sexPercent'
import hotPicData from '@/static/mockJson/hotpic'
import trail from '@/pages/vip2/trail'
import bottomPicture from '@/pages/vip2/bottomPicture'
import customerInfo from '@/pages/vip2/customerInfo'
import preciousMetal from '@/pages/vip2/preciousMetal'
...
.tip_left_top{
  background: url(../../static/image/bubble/vipTip_1.png) 0 center no-repeat;
  background-repeat: no-repeat;
  left: 800px;
  top: 630px;
}
.tip_left_bottom{
  background: url(../../static/image/bubble/vipTip_2.png);
  background-repeat: no-repeat;
  left: 796px;
  top: 871px;
}
.tip_right_top{
  background: url(../../static/image/bubble/vipTip_3.png);
  background-repeat: no-repeat;
  right: 818px;
  top: 629px;
}
.tip_right_bottom{
  background: url(../../static/image/bubble/vipTip_4.png);
  background-repeat: no-repeat;
  right: 818px;
  top: 871px;
}
