 ...
 * @Last Modified time: 2018-08-21 10:58:40
 */

<template>
  <div id="customerInfoVip2">
    <div class="customer_suggest">
      <div class="suggest_pro_left">
          <div  class="_title _title-left">客户接待人数</div>
            <div class="_fail">
                <num-free-style number="149" :length="3"></num-free-style>
            </div>
      </div>
      <div class="suggest_pro_right">
        <div class="_title">推荐产品成功率</div>
            <div class="_success">
                <num-free-style number="28" :length="2"></num-free-style><span class="per">%</span>
            </div>
      </div>
    </div>
    <div class="customer_type">
        <div class="_title">客户类型统计</div>
        <div id="customerTypeBarVip2"></div>
    </div>
  </div>
</template>
<script>
...
export default {
  name: 'customerInfoVip2',
  props: {},
  data () {
    return {
      customerReData: [22, 28, 20, 18],
  ...
  methods: {
    initCustomerInfoEcharts () {
      let _this = this
      let myChart = echarts.init(document.getElementById('customerTypeBarVip2'))
      let option = {
        legend: {
          right: '6%',
          top: '20%',
